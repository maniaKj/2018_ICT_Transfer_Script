...
public class Tower_AIchange : MonoBehaviour {
    ...
    //private
    Material mt;
    MagneticMachine tower_test_script;
	...
	void Awake () {
        ...
        tower_test_script = GetComponent<MagneticMachine>();
	}
    ...
    void State_change(int state_into)
    {
        switch (state_into)
        {
            case 4:
                //mt.color = Color.blue;
                tower_test_script.TowerFunc = MagneticMachine.TowerStyle.CNN;
                break;
            case 8:
                //mt.color = Color.yellow;
                tower_test_script.TowerFunc = MagneticMachine.TowerStyle.Electric;
                break;
            /*case 3:
