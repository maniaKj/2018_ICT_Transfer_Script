...
public class player_shot : MonoBehaviour
{
    ...
    [HideInInspector] public GameObject Connectec_Data_Obj;
    ...
    [HideInInspector]public Module_Lable previous_script_ML;
    ...
    void Ray_Check()
    {
        ...
        if (Physics.Raycast(ray, out hit, 1000, ray_Layermask))
        {
            ...
            if (hit.transform.GetComponent<Data_Hologram>() != null && Vector3.Distance(hit.transform.position, this.transform.position) < Hologram_Check_Distance) Cnn_Obj_Check = true;
    ...
    public void Module_buffer_return()
    {
        ...
        else if (module_Buffer <= 50)
        {
            ...
            else Connectec_Data_Obj.SetActive(true);
