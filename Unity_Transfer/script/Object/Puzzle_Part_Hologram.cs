...
public class Puzzle_Part_Hologram : MonoBehaviour {
    ...
    void Disassemble()
    {
        ...
        {
            module_Linked.GetComponent<Module_Lable>().Get_disassemble_Signal(0);
            module_Linked.SendMessageUpwards("Object_Unlinking", module_Linked.GetComponent<Module_Lable>().ModuleID);
        }
